...
An experiment using a replicated Twitter API stream shows that the implementation is capable of throughput of over three times the full stream of global tweets on Twitter.
