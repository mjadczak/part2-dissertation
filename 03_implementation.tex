...
\begin{figure}[h]
	...
	\caption[A simple Pipeline constructed in \cref{lst:impl:elixir-construct-pipeline}.]{\Cref{lst:impl:elixir-construct-pipeline} constructs a simple Pipeline.}
...
\begin{figure}[h]
	...
	\caption[A branching Pipeline constructed in \cref{lst:impl:diverging-pipelines}.]{\Cref{lst:impl:diverging-pipelines} constructs a Pipeline with branching---the result of \texttt{ExtractWords} is consumed by two other Transforms.}
