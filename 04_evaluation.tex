...
\Cref{tab:todo} shows the full Beam Capability Matrix augmented with a column detailing the implementation areas of this project.

\todo{include capability matrix}
